<div class="wrap">
    ...
    <h2 class="nav-tab-wrapper">
        <a href="?page=wp_birdlife_admin&tab=automatic_sync_settings"
           class="nav-tab <?php echo $active_tab == 'automatic_sync_settings' ? 'nav-tab-active' : ''; ?>">Automatic
            sync</a>
        <a href="?page=wp_birdlife_admin&tab=hard_refresh_settings"
	...
	if ( $active_tab == 'automatic_sync_settings' ) {
		...
		do_settings_sections( 'wp_birdlife_page1' );
